...
# ONE single Endpoint List / Detail / Update Delete
# we Dont work with it like that for too many reasons it make problems with the
# requests and respond data
...
#     def perform_destroy(self, isinstance):
#         '''
#         make the test work with out user
#         '''
#         if isinstance is not None:
#             return isinstance.delete()
#         return None
